 ...
 * satlog.h
 *
 * Copyright (c) 2005-  Sigma Resources & Technologies, Inc.
 *
...
// SYSLOGP(RFC3164)	<priority>Mmm dd hh:mm:ss yyyy sysname module/level/digest:content
// SATLOGP			<type testbed jobid subid testcase> :content

/* facility codes */
#define SATLOGP_TYPE_SYSTEM		0	/**< system log message */
#define SATLOGP_TYPE_USER		1	/**< user record log */
#define SATLOGP_TYPE_EXPECT		2	/**< device or node output while execute expect */
#define SATLOGP_TYPE_OTHER		3	/**< other log message */

#define LOG_SYSTEM		(0x01 << 4)	/**< system log message */
#define LOG_USERX		(0x02 << 4)	/**< user log */
...
#define LOG_TYPE(type) ((type) >> 4)	/**< get current log type by log mask */
